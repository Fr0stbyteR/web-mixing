export const registeredProcessors: WeakMap<AudioWorklet, Set<string>> = new WeakMap();
export const registeringProcessors: WeakMap<AudioWorklet, Set<string>> = new WeakMap();
export const resolves: Record<string, ((value?: void | PromiseLike<void>) => void)[]> = {};
export const rejects: Record<string, ((reason?: any) => void)[]> = {};
